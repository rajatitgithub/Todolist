...
add_button = tk.Button(button_line, text="Add Task", command=add_task, bg="white", fg="black")
add_button.grid(row=0, column=0)

delete_button = tk.Button(button_line, text="Delete Task", command=delete_task, bg="red", fg="white")
delete_button.grid(row=0, column=1)

update_button = tk.Button(button_line, text="Update Task", command=update_task, bg="yellow", fg="red")
